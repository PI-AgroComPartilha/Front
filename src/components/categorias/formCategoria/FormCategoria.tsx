...
function FormCategoria() {
  ...
  return (
    ...
    <div className="bg-opacity-50 bg-[url('https://ik.imagekit.io/vmo8ef1xo/PI%20-AgroComPartilha/imagens%20login%20cadastro/outside-312569288.jpg?updatedAt=1717608899134')] bg-cover bg-no-repeat h-screen flex justify-center items-center flex-col">

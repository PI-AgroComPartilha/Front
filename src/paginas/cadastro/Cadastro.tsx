...
function Cadastro() {
  ...
  return (
    <div className=" bg-[url('https://img.freepik.com/fotos-premium/mao-segurando-soja-com-platation-e-o-ceu-no-horizonte-e-detalhes-em-macro_44762-1027.jpg?w=740')] bg-cover bg-no-repeat h-screen ">
      <div className="container mx-auto flex items-center flex-col h-full">
        <div
          className="text-gray-800/80 bg-white/15 backdrop-blur-md mt-[10vh] w-2/3 max-w-[500px] rounded-xl p-5"
        >
          <form
